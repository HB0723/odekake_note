...
ActiveRecord::Schema[8.1].define(version: 2026_09_23_104719) do
  ...
  create_table "packing_items", force: :cascade do |t|
    ...
    t.string "title", null: false
    t.datetime "updated_at", null: false
    t.index ["outing_id"], name: "index_packing_items_on_outing_id"
  end
  ...
  add_foreign_key "packing_items", "outings"
